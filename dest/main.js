...
class GUI {
    ...
    addCheckbox() {
        const CHECKBOXES = [...document.querySelectorAll('.GUI_CHECKBOX')];
    ...
    addSlider() {
        const SLIDERS = [...document.querySelectorAll('.GUI_SLIDER ')];
    ...
    addFolder() {
        ...
        const FOLDERS = [...document.querySelectorAll('.GUI_FOLDER ')];
        for (const folder of FOLDERS) {
            this.carray.push(new Folder(folder));
        }
        const FOLDER_BUTTONS = [...document.querySelectorAll('.GUI_FOLDER_TITLE')];
